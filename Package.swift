...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kitura-Next/Kitura-NIO.git", from: "2.2.0"),
        .package(url: "https://github.com/Kitura-Next/BlueCryptor.git", from: "1.0.0"),
        .package(url: "https://github.com/Kitura-Next/Kitura-WebSocket-Compression.git", from: "0.1.0")
    ],
    targets: [
